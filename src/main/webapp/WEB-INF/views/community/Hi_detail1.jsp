					...
					<div class="midd">
						<ul>
							<li id="li_0"><a class="small_img_box on"> <img
									...
									src="${pageContext.request.contextPath}/assets/img/hi_2/001.png" />
							</a></li>
							<li id="li_1"><a class="small_img_box"> <img
									class="small_img" id="1"
									src="${pageContext.request.contextPath}/assets/img/hi_2/002.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
							<li id="li_2"><a class="small_img_box"> <img
									class="small_img" id="2"
									src="${pageContext.request.contextPath}/assets/img/hi_2/003.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
							<li id="li_3"><a class="small_img_box"> <img
									class="small_img" id="3"
									src="${pageContext.request.contextPath}/assets/img/hi_2/004.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
							<li id="li_4"><a class="small_img_box"> <img
									class="small_img" id="4"
									src="${pageContext.request.contextPath}/assets/img/hi_2/005.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
							<li id="li_5"><a class="small_img_box"> <img
									class="small_img" id="5"
									src="${pageContext.request.contextPath}/assets/img/hi_2/006.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
							<li id="li_6"><a class="small_img_box"> <img
									class="small_img" id="6"
									src="${pageContext.request.contextPath}/assets/img/hi_2/007.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
							<li id="li_7"><a class="small_img_box"> <img
									class="small_img" id="7"
									src="${pageContext.request.contextPath}/assets/img/hi_2/007.png"
									alt="220106_2022 교육부 업무보고 02">
							</a></li>
