...
<body>
	...
	<div class="main_box">
		...
		<div class="snu_main_box">
			...
			<form class="qna_write_form" method="post"
				...
				<div>
					<b>공개설정</b> 
					<label for="category3"> <input id="category3" type="radio" name="postpublic" value="공개">공개</label> 
					<label for="category4"><input id="category4" type="radio" name="postpublic" value="비공개">비공개</label>
				</div>

				<div>
					<b>익명여부</b> 
					<label for="category5"><input id="category5" type="radio" name="posttype" value="익명">익명</label> 
					<label for="category6"><input id="category6" type="radio" name="posttype" value="실명">실명</label>
				</div>
				<div style="margin-top: 30px;">
					<input id="title" name="posttitle" style="width: 60%; padding: 10px 5px; font-weight: bold;"
	...
	<script>
		$(function() {
			$(".qna_write_form").submit(function(e) {
				...
				if (!regex.value('#title', '제목을 입력하세요.')) {
					return false;
				}
