...
<body>
    ...
    <div class="main_box">
        ...
        <div class="snu_main_box">
            <div class="snu_main_header">
                <span>과별 졸업로드맵</span> <span style="font-size: 16px; color: rgba(0, 0, 0, 0.6);">${department.dname}</span>
            ...
            <div class="snu_detail_loadmap_main">
                <div class="snu_class_name_box">
                    <img src="${pageContext.request.contextPath}/assets/img/2_class_loadmap/class/${department.image}.png" />
                </div>
                <div class="snu_class_file_box">
                    <div><a href="${pageContext.request.contextPath}/file/loadmap/${department.image}">${department.dname}_졸업로드맵</a></div>
                    <div><a href="${pageContext.request.contextPath}/file/self_check/${department.image}">${department.dname}_자가진단표</a></div>
                </div>
            </div>
            ...
            <div class="snu_loadmap_table_info">
                <div style="margin-top: 20px;">
                    <b>1. 교직 적성 인성 검사</b>
                    <br>
                    <span>1 ) 매 학기 초 신청(1학기 3월 ,2학기 9월)</span>
                    <br>
                    <span>2 ) 두 학기 연속으로 검사를 신청할 수 없음(원칙상 1/2학년에 1차, 3/4학년에 2차 검사)</span>
                </div>

                <div style="margin-top: 20px;">
                    <b>2. 응급처치 및 심폐소생술 교육</b>
                    <br>
                    <span>1 ) 매 학기 초 신청, 단체 교육 신청 기간을 놓쳤을 시 서울대하교 보건진료소 홈페이지(http://cpr.snu.ac.kr)에서 개별 신청</span>
                    <br>
                ...
                <div style="margin-top: 20px; margin-bottom: 200px;">
                    <b>3. 성인지교육</b>
                    <br>
                    <span>1 ) 연 1회씩 총 4회 필수 이수</span>
                    <br>
                    <span>2 ) 연 1회만 수강 가능</span>
                    <br>
                    <span>3 ) 매 회 총4차시의 과정 이수(1~2차시 : 인권센터(https://helpms.snu.ac.kr/)의 인권-성평등 교육 이수, 3~4차시 : 교원양성센터 대면
                        강의)</span>
                </div>
    ...
    <div class="snu_mobile_box">
        ...
        <div class="snu_mobile_main_box">
            ...
            <div class="snu_detail_loadmap_main">
                <div class="snu_class_name_box">
                    <img src="${pageContext.request.contextPath}/assets/img/2_class_loadmap/class/eng_edu.png" />
                </div>
                <div class="snu_class_file_box">
                    <div>다운로드박스1</div>
                    <div>다운로드박스2</div>
