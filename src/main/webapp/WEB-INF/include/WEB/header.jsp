  ...
  <div class="header_box">
        ...
        <div class="snu_tab_box">
            ...
            <div class="snu_tab_menu">
                ...
                <div class="snu_tab_menu_content hidden">
                    <div class="snu_tab_menu_inner_box"><a href="${pageContext.request.contextPath}/community/Q&A.do">건의 및 Q&A</a></div>
                    <div class="snu_tab_menu_inner_box"><a href="#">MBTI 게임</a></div>
                    <div class="snu_tab_menu_inner_box"><a href="${pageContext.request.contextPath}/community/FAQ.do">FAQ</a></div>
                    <div class="snu_tab_menu_inner_box"><a href="${pageContext.request.contextPath}/community/Hi.do">Hi 사범</a></div>
                </div>
            </div>

            <div class="snu_tab_menu">
                <div class="snu_tab_btn"><a href="${pageContext.request.contextPath}/community/announce.do">공지사항</a></div>
            </div>
            ...
            <div class="snu_tab_menu">
                ...
                <div class="snu_tab_menu_content hidden">
                    <div class="snu_tab_menu_inner_box"><a href="${pageContext.request.contextPath}/loadmap/snu_class_loadmap.do">과별 졸업로드맵</a></div>
                    <div class="snu_tab_menu_inner_box"><a href="${pageContext.request.contextPath}/loadmap/snu_education_loadmap.do">교직 로드맵</a></div>
                </div>
            </div>
