...
public class CalendarController {
	...
	@RequestMapping(value = "reservation/reservation_insert.do", method = RequestMethod.POST)
	public ModelAndView reservation_insert(Locale locale, Model model, HttpServletRequest request,
